export const FULL_NAME = "Seth Rojas";
export const SETH_DEV_NAMES: string[] = ["Software Developer", "Data Scientist"]
...
export const RESUME_PATH: string = "/resume/Seth_Rojas_Resume.pdf";